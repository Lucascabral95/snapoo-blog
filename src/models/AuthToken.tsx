...
export type AuthTokenPurpose = "email-verification" | "password-reset" | "email-change";
...
const authTokenSchema = new mongoose.Schema<AuthTokenDocument>({
  ...
  purpose: { type: String, enum: ["email-verification", "password-reset", "email-change"], required: true },
